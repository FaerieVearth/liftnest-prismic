...
{/*       <AnimatedContent>
      ...
      <div className="grid items-center rounded-xl border border-blue-300/35 bg-gradient-to-b from-[#fc5f2f]/10 to-[#fc5f2f]/5 px-8 py-8 backdrop-blur-sm lg:grid-cols-3 lg:py-12">
        <div>
{/*           <div className="w-fit rounded-lg bg-blue-300/35 p-4 text-4xl">
          ...
          <ButtonLink
            ...
            className="mb-6 mt-6 lg:mb-0 bg-[#383D2A] text-white"
          >
        ...
        <PrismicNextImage
          ...
          className={clsx(
            "rounded-xl opacity-90 shadow-2xl lg:col-span-2 lg:pt-0 object-cover max-h-[400px]",
